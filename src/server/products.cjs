...
function getShopsChart(dateRange) {
    // предпосчитанные данные для одного товара
    // https://github.com/annareshetnik/Data-science-projects/blob/main/Hackaton_markirovka_03_24_23_v04.ipynb
    // TODO предрасчитать для всех и сделать табличку
